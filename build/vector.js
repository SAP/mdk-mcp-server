 ...
 */
function loadDocumentsFromFolder(folderPath, allowedExts = new Set([".json", ".schema", ".js"])) {
    const docs = [];
...
export function retrieveAndStoreRule(folderPath) {
...
export async function searchRuleNames(query, topN = 1) {
